...
DEFINE_int32(timeout_ms, 10, "RPC timeout in milliseconds");
...
int main(int argc, char* argv[]) {
    ...
    while (!brpc::IsAskedToQuit()) {
        ...
        // oneway method, only request, no respose needed
        stub.CallMethod("Ping", &cntl, &req, NULL);
        ...
        if (cntl.Failed()) {
            ...
            LOG(INFO) << "Oneway Method, Thrift Request: [" << req.data << "] No Thrift Response!";
        }
